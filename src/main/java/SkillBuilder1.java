...
public class SkillBuilder1 {
    ...
    public static void main(String[] args) {
       ...
       double expressions = 4.0/3*Math.pow(2,Math.sqrt(5)/Math.pow(spice,3));
        System.out.println("Well " + user+", the spice value resulted in " + expressions);
        System.out.println("And the converted value is " + Math.round(expressions * 100.0) / 100.0);
    }
